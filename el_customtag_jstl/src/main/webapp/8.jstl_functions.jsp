...
<ul>
	<li>--JSTL에서제공하는 EL내에서사용가능한function(^-^)---</li>
	...
	<li>가격:&dollar;&dollar; {new DecimalFormat("#,###,###.0").format(price)} --> 안됨.</li>
	<li>가격:&dollar;${NumberFormatter.format(price,"#,###,###.0")} --> 요렇게 만들어서 import</li>
